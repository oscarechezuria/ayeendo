...
export default function Header() {
  ...
  return (
    <header className='flex flex-col justify-between bg-one-500 p-4 text-white font-medium text-lg md:flex md:flex-row'>
        ...
        <nav className={`absolute top-14 px-4 py-6 right-0 mr-4 bg-two-500 rounded-md md:bg-one-500 md:mr-2 md:static md:flex md:gap-2 ${show === false ? "hidden" : "visible"} duration-500`}>
            <ul className='flex flex-col items-center gap-8 md:flex md:flex-row md:gap-6 md:mt-0'>
